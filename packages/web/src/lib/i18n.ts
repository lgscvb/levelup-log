...
export const translations: Record<Locale, Translations> = {
  'en': {
    ...
    dashboard: {
      title: 'Dashboard', publicProfile: 'Public Profile', settings: 'Settings',
      totalXp: 'Total XP', yearXp: 'Year XP', streak: 'Streak', bestStreak: 'Best Streak',
      recentAchievements: 'Recent Achievements',
      noAchievements: 'No achievements yet. Start using the MCP to record your first!',
      noAchievementsHint: '# Install in one command',
    },
    settings: {
      title: 'Settings', displayName: 'Display Name', bio: 'Bio',
      birthDate: 'Birth Date (your level = your age)', publicDefault: 'Achievements public by default',
      save: 'Save Settings', saving: 'Saving...', saved: 'Settings saved!', signOut: 'Sign Out',
    },
  },
  'zh-TW': {
    ...
    dashboard: {
      title: '儀表板', publicProfile: '公開頁面', settings: '設定',
      totalXp: '總 XP', yearXp: '年度 XP', streak: '連續天數', bestStreak: '最佳連續',
      recentAchievements: '最近成就',
      noAchievements: '還沒有成就。開始使用 MCP 記錄你的第一個！',
      noAchievementsHint: '# 一行指令安裝',
    },
    settings: {
      title: '設定', displayName: '顯示名稱', bio: '個人簡介',
      birthDate: '生日（你的等級 = 你的年齡）', publicDefault: '成就預設公開',
      save: '儲存設定', saving: '儲存中...', saved: '設定已儲存！', signOut: '登出',
    },
  },
  'zh-CN': {
    ...
    dashboard: {
      title: '仪表盘', publicProfile: '公开页面', settings: '设置',
      totalXp: '总 XP', yearXp: '年度 XP', streak: '连续天数', bestStreak: '最佳连续',
      recentAchievements: '最近成就',
      noAchievements: '还没有成就。开始使用 MCP 记录你的第一个！',
      noAchievementsHint: '# 一行命令安装',
    },
    settings: {
      title: '设置', displayName: '显示名称', bio: '个人简介',
      birthDate: '生日（你的等级 = 你的年龄）', publicDefault: '成就默认公开',
      save: '保存设置', saving: '保存中...', saved: '设置已保存！', signOut: '退出登录',
    },
  },
  'ja': {
    ...
    dashboard: {
      title: 'ダッシュボード', publicProfile: 'プロフィール公開', settings: '設定',
      totalXp: '総XP', yearXp: '年間XP', streak: 'ストリーク', bestStreak: '最高ストリーク',
      recentAchievements: '最近の実績',
      noAchievements: 'まだ実績がありません。MCPを使って最初の実績を記録しよう！',
      noAchievementsHint: '# ワンコマンドでインストール',
    },
    settings: {
      title: '設定', displayName: '表示名', bio: '自己紹介',
      birthDate: '誕生日（あなたのレベル = あなたの年齢）', publicDefault: '実績をデフォルトで公開',
      save: '設定を保存', saving: '保存中...', saved: '設定を保存しました！', signOut: 'サインアウト',
    },
  },
  'ko': {
    ...
    dashboard: {
      title: '대시보드', publicProfile: '공개 프로필', settings: '설정',
      totalXp: '총 XP', yearXp: '연간 XP', streak: '스트릭', bestStreak: '최고 스트릭',
      recentAchievements: '최근 성취',
      noAchievements: '아직 성취가 없습니다. MCP를 사용해 첫 번째 성취를 기록하세요!',
      noAchievementsHint: '# 한 줄 명령어로 설치',
    },
    settings: {
      title: '설정', displayName: '표시 이름', bio: '자기소개',
      birthDate: '생일 (레벨 = 나이)', publicDefault: '성취 기본 공개',
      save: '설정 저장', saving: '저장 중...', saved: '설정이 저장되었습니다!', signOut: '로그아웃',
    },
  },
  'es': {
    ...
    dashboard: {
      title: 'Panel', publicProfile: 'Perfil público', settings: 'Configuración',
      totalXp: 'XP Total', yearXp: 'XP del año', streak: 'Racha', bestStreak: 'Mejor racha',
      recentAchievements: 'Logros recientes',
      noAchievements: 'Aún no hay logros. ¡Empieza a usar el MCP para registrar el primero!',
      noAchievementsHint: '# Instalar en un comando',
    },
    settings: {
      title: 'Configuración', displayName: 'Nombre visible', bio: 'Biografía',
      birthDate: 'Fecha de nacimiento (tu nivel = tu edad)', publicDefault: 'Logros públicos por defecto',
      save: 'Guardar', saving: 'Guardando...', saved: '¡Configuración guardada!', signOut: 'Cerrar sesión',
    },
  },
  'pt-BR': {
    ...
    dashboard: {
      title: 'Painel', publicProfile: 'Perfil público', settings: 'Configurações',
      totalXp: 'XP Total', yearXp: 'XP do ano', streak: 'Sequência', bestStreak: 'Melhor sequência',
      recentAchievements: 'Conquistas recentes',
      noAchievements: 'Nenhuma conquista ainda. Comece a usar o MCP para registrar a primeira!',
      noAchievementsHint: '# Instalar com um comando',
    },
    settings: {
      title: 'Configurações', displayName: 'Nome de exibição', bio: 'Bio',
      birthDate: 'Data de nascimento (seu nível = sua idade)', publicDefault: 'Conquistas públicas por padrão',
      save: 'Salvar', saving: 'Salvando...', saved: 'Configurações salvas!', signOut: 'Sair',
    },
  },
};
